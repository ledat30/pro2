...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( selector, options )
	{
		 ...
		 *  @param {string} sClass Class_code to give the new TD cell
		...
		if ( aoColDefs )
		{
			...
			for ( i=aoColDefs.length-1 ; i>=0 ; i-- )
			{
				...
				for ( j=0, jLen=aTargets.length ; j<jLen ; j++ )
				{
					...
					{
						/* Class_code name matching on TH element */
	...
	DataTable.models.oColumn = {
		...
		/**
		 * Class_code to be applied to the header element when sorting on this column
		 *  @type string
		 *  @default null
		 */
		"sSortingClass": null,
	...
	DataTable.defaults.column = {
		...
		/**
		 * Class_code to give to each cell in this column.
		 *  @type string
		 *  @default <i>Empty string</i>
		 *
