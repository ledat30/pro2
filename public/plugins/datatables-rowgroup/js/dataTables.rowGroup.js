...
$.extend( RowGroup.prototype, {
	 ...
	 * @param {string} className Class_code to add to the row
	 * @param {array} group
...
RowGroup.defaults = {
	/**
	 * Class_code to apply to grouping rows - applied to both the start and
	 * end grouping rows.
	 * @type string
	 */
	...
	/**
	 * Class_code name to give to the end grouping row
	 * @type string
	 */
	...
	/**
	 * Class_code name to give to the start grouping row
	 * @type string
	 */
